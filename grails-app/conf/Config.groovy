...
log4j = {
    appenders {
		appender new org.apache.log4j.DailyRollingFileAppender (
			name:"dailyAppender",
			layout:pattern(conversionPattern: '[%p] %d %c{2} %m%n'),
			fileName:properties.getProperty("log4j.fileName"),
			datePattern:"'.'yyyy-MM-dd"
		)
		console name:'stdout', layout:pattern(conversionPattern: '[%p] %d %c{2} %m%n')
	}
...
filePath {
	...
	download = properties.getProperty("filePath.download")
}
