...
<html lang="en">
	<head>
		...
		<meta name="description" content="微盘管理登录" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		<script src="${request.contextPath}/ace/js/jquery-1.10.2.min.js"></script>
		<!-- bootstrap & fontawesome -->
		<link rel="stylesheet" href="${request.contextPath }/ace/css/bootstrap.min.css" />
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${request.contextPath}/ace/css/ace-part2.min.css" />
		<![endif]-->
	...
	<body class="login-layout">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">微盘</span>
									<span class="white" id="id-text2">管理后台</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; 小马科技</h4>
							</div>
		...
		<script type="text/javascript">
			 function login(){
			 	$.ajax({
			 		url: '${request.contetPath}/wechatmarket/login/doLogin',
			 		type: 'POST',
			 		data: $("#loginForm").serialize(),
			 		success:function(res){
			 			
			 			if(res=="success"){
			 				window.location.href = '${request.contetPath}/wechatmarket/admin/index'
			 			}else{
			 				alert("账号错误！");
			 			}
			 		}
